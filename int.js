...
<div class="meat">
    ...
    <div><h2>7,50€</h2><br><br><br></div>
</div>
<div class="meat">
    <div><h3>Ingedients: Meat of your choice, Tomato, Onion, Salad of your Choice and French Fries</h3></div>
</div>
</div>`
...
function buildSand(){
    ...
    <div class="meat">
        ...
        <div><h2>2,80€</h2><br></div>
    </div>
    <div class="meat">
        <div><h2>Meatball Handmade</h2></div>
        <div><h2>3,20€</h2><br><br><br></div>
    </div>
    ...
    <div class="meat">
        <div><h3>Ingedients: Meat of your choice, Tomato, Onion, Ketchup, Mustard and French fries</h3></div>
    </div>
</div>`;
